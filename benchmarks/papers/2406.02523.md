...
|     |           |          |       | Nasiriany1, |          |             | Maddukuri1,∗, |                  | Zhang1,∗,  |      | Parikh1, |     |     |     |     |
|     |           | Soroush  |       |             | Abhiram  |             |               | Lance            |            |      | Adeet    |     |     |     |     |
...
robocasa.ai
4202 nuJ 4  ]OR.sc[  1v32520.6042:viXra
...
|               |                 |        |               |            |                |           |          | processing      | domains, | where  | massive  | visual  | and         | text data    | are |
| training      | generalist      | robots | in everyday   |            | environments.  | RoboCasa  |          |                 |          |        |          |         |             |              |     |
...
createlarge,diversedatasetsfortraininggeneralistrobotmod-
modelsandenvironmenttexturesfromtext-to-imagemodels.We
...
thewild.Itraisesthequestion—whatisaviablepathforward
| human burden. |     | Our experiments |     | show | a clear scaling |     | trend | in  |     |     |     |     |     |     |     |
| ------------- | --- | --------------- | --- | ---- | --------------- | --- | ----- | --- | --- | --- | --- | --- | --- | --- | --- |
usingsyntheticallygeneratedrobotdataforlarge-scaleimitation toward scaling in robot learning?
learning and show great promise in harnessing simulation data As collecting ever-larger datasets in the real world would
...
quantities of synthetic data for model training. We expect skills. We design these composite tasks to capture naturalistic
...
other 75 are composite tasks involving a sequence of robot objects while incorporating AI-generated tasks and assets,

K
|         |     |      | Casa |       | O R     | 2.0    | 2.0 | RLBench | Behavior-1 | mic  | ManiSkill | 2    | US  |        | O Gen |
| ------- | --- | ---- | ---- | ----- | ------- | ------ | --- | ------- | ---------- | ---- | --------- | ---- | --- | ------ | ----- |
|         |     |      |      | H     | Habitat | Gibson |     |         |            | mi   |           |      | M   | LIBE R | mic   |
| Feature |     | Robo |      | AI2-T |         |        |     |         |            | robo |           | OPTI |     |        |       |
Mi
i
| Mobile Manipulation |         |     | ✓   | ✓   | ✓   |     | ✓   | ✗   | ✓   | ✗   | ✓   |     | ✗   | ✗   | ✓   |
| ------------------- | ------- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
datasetprovidedbyRoboCasawillfulfillacrucialrequirement
|     |     |     |     |     |     |     |     | ing | [25] is | an alternative | method | that | tries | to prefer | certain |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | ------- | -------------- | ------ | ---- | ----- | --------- | ------- |
...
Datasets and Benchmarks for Robotics.Recently,several datasets [19, 3, 11, 23, 22]. In this work, we use Behavioral
|     |     |     |     |     |     |     |     | Cloning | using | a Transformer-based |     |     | [43] | visuomotor | policy |
| --- | --- | --- | --- | --- | --- | --- | --- | ------- | ----- | ------------------- | --- | --- | ---- | ---------- | ------ |
large-scaledatacollectioneffortshavebeenmadeforrobotics.
One approach is self-supervised learning, where trial-and- similar to other works [6] to train agents on large offline
...
operatorsoverextendedperiodsoftime[9,1,16,2].However, scenes, furniture and appliances, and objects.
...
simulation,whereresultsareeasiertoreproduceandthorough WeadoptRoboSuite[51]asthecoresimulationplatformon
...
strations in simulation and then leverage MimicGen [34]. photorealistic images (see Figure 1).

One wall One wall w/ island L-shaped L-shaped w/ island Galley
...
comeswithdozensofappliances.Severaltypesofappliancesarearticulated.
compilethepopularkitchenstyles,includingIndustrial,Scan-
...
| these styles   | across | different     |      | floor     | plans in | Figure     | 1. Each   |                 |             |       |            |       |                 |     |
| -------------- | ------ | ------------- | ---- | --------- | -------- | ---------- | --------- | --------------- | ----------- | ----- | ---------- | ----- | --------------- | --- |
|                |        |               |      |           |          |            |           | turns on        | to simulate | heat. | See Figure | 4 for | an illustration | of  |
| floor plan     | can    | be configured |      | to take   | on any   | style,     | resulting | our appliances. |             |       |            |       |                 |     |
| in 120 kitchen |        | scenes.       | Each | scene can | be       | customized | further   |                 |             |       |            |       |                 |     |
Inadditiontoappliances,wecreatearichlibraryofobjects
...
| for the floor, | 100 | for | counters, | and | 100 for | cabinet | panels. |               |      |              |     |           |             |     |
| -------------- | --- | --- | --------- | --- | ------- | ------- | ------- | ------------- | ---- | ------------ | --- | --------- | ----------- | --- |
|                |     |     |           |     |         |         |         | object assets | from | two sources, | the | Objaverse | [8] dataset | and |
Weusethepopulartext-to-imagetoolMidJourneytogenerate Luma.ai, an online text-to-3D service. We mine a large set of
| these images. |     | We use | these | textures | as a | form | of domain |           |         |            |               |     |             |       |
| ------------- | --- | ------ | ----- | -------- | ---- | ---- | --------- | --------- | ------- | ---------- | ------------- | --- | ----------- | ----- |
|               |     |        |       |          |      |      |           | candidate | objects | and filter | out defective | or  | low-quality | ones. |
...
| commodate | diverse | kitchen          | activities. |                | Our repository |           | includes |              |        |          |     |     |     |     |
IV. ROBOCASAACTIVITYDATASET
...
entities, for example, segmenting the door of a microwave large multi-task dataset accompanying them.

|     |     |     |     |     |     | code implementations |                 |          | for them.     | Except    | for         | a select      | number       |
| --- | --- | --- | --- | --- | --- | -------------------- | --------------- | -------- | ------------- | --------- | ----------- | ------------- | ------------ |
...
|           |          |          |         |             |                    | SpaceMouse   | [50,           | 51].  | Each task | demonstration |        | is    | collected in |
|           |          |          |         |             |                    | a random     | kitchen        | scene | (random   | kitchen       | floor  | plan, | random       |
| For a     | robot to | perform  | complex | tasks,      | it must master the |              |                |       |           |               |        |       |              |
...
|     |     |     |     |     |     | operation | (1,250 | demonstrations). |     | However, |     | our | experiments |
| --- | --- | --- | --- | --- | --- | --------- | ------ | ---------------- | --- | -------- | --- | --- | ----------- |
majorityofhouseholdactivities:1)Pickandplace,2)Opening
andclosingdoors,3)Openingandclosingdrawers,4)Twisting showthateventhisscaleofhumandataisinsufficienttosolve
|     |     |     |     |     |     | most of | our tasks. | This | is likely | due | to the | significant | scope |
| --- | --- | --- | --- | --- | --- | ------- | ---------- | ---- | --------- | --- | ------ | ----------- | ----- |
knobs,5)Turninglevers,6)Pressingbuttons,7)Insertion,and
...
|         |            |              |     |         |                     | Leveraging | automated |     | trajectory |     | generation |     | methods to |
| ------- | ---------- | ------------ | --- | ------- | ------------------- | ---------- | --------- | --- | ---------- | --- | ---------- | --- | ---------- |
| such as | deformable | manipulation |     | is left | for future work. To |            |           |     |            |     |            |     |            |
...
75 task blueprints in total from the LLM and proceed to of demonstrations.

Activity Prompting
|                              |     |     |     | GPT-4 |     |     | List of activitie |                  |     |     |     | Task Generation Process |     |                  |     |
| ---------------------------- | --- | --- | --- | ----- | --- | --- | ----------------- | ---------------- | --- | --- | --- | ----------------------- | --- | ---------------- | --- |
|                              |     |     |     |       |     |     |                   | Chopping Foo     |     |     |     |                         |     |                  |     |
|                              |     |     |     |       |     |     |                   |                  |     |     |     | pick(vegetable)         |     | place(microwave) |     |
| Can you give me 30 simple    |     |     |     | ...   |     |     |                   | Fryin            |     |     |     |                         |     |                  |     |
| everyday kitchen activities? |     |     |     |       |     |     |                   | Serving Food ... |     |     |     |                         |     |                  |     |
...
Task Prompting
Task: Prepare Microwave Steaming

Goal: Put a bowl of vegetables inside
Your goal is to come up with 15  ... place(bowl) close_door(microwave)
the microwave to steam them there.
...
| data generation | across     | multiple | simulation |     | processes | to  | speed |        |          |            |     |          |               |       |           |
| --------------- | ---------- | -------- | ---------- | --- | --------- | --- | ----- | ------ | -------- | ---------- | --- | -------- | ------------- | ----- | --------- |
|                 |            |          |            |     |           |     |       | erated | dataset, | where      | we  | generate | 300           | demos | per task. |
| up the data     | generation | process. |            |     |           |     |       |        |          |            |     |          |               |       |           |
|                 |            |          |            |     |           |     |       | This   | results  | in a total | of  | 7,200    | trajectories. |       |           |
V. EXPERIMENTS 4) Generated-100: A random 1/30 subset of our full gen-
|              |            |               |     |          |           |     |        | erated | dataset, | where      | we  | generate | 100           | demos | per task. |
| ------------ | ---------- | ------------- | --- | -------- | --------- | --- | ------ | ------ | -------- | ---------- | --- | -------- | ------------- | ----- | --------- |
| We aim       | to explore | the following |     | research | questions |     | in our |        |          |            |     |          |               |       |           |
...
| learning | policy | scale | with | increasing | training |     | dataset |            |     |              |     |       |          |       |          |
| -------- | ------ | ----- | ---- | ---------- | -------- | --- | ------- | ---------- | --- | ------------ | --- | ----- | -------- | ----- | -------- |
|          |        |       |      |            |          |     |         | resembling | the | Omni-Frankie |     | robot | [13]. We | train | a visuo- |
...
| One question | we  | are interested | in  | is how | the performance |     | of  |            |       |          |        |          |         |                |     |
| ------------ | --- | -------------- | --- | ------ | --------------- | --- | --- | ---------- | ----- | -------- | ------ | -------- | ------- | -------------- | --- |
|              |     |                |     |        |                 |     |     | a distinct | floor | plan and | style. | In order | to test | generalization |     |
...
| data plays | a role | in performance. |     | We compare | the | following |     |     |     |     |     |     |     |     |     |
| ---------- | ------ | --------------- | --- | ---------- | --- | --------- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
unseenstylesthatwereneverencounteredinthetrainingdata.
...
|     |     |     |     |     |     |     |     | fully generated |     | dataset, we | observe | a   | significant | improvement |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --------------- | --- | ----------- | ------- | --- | ----------- | ----------- | --- |
demonstrations.
|                    |     |              |         |           |                |     |        | at 47.6%   | success      | rate.             | Furthermore, |       | we observe  |             | a scaling |
| ------------------ | --- | ------------ | ------- | --------- | -------------- | --- | ------ | ---------- | ------------ | ----------------- | ------------ | ----- | ----------- | ----------- | --------- |
| 2) Generated-3000: |     | A            | dataset | of 72,000 | demonstrations |     |        |            |              |                   |              |       |             |             |           |
|                    |     |              |         |           |                |     |        | trend from | using        | machine-generated |              | data: | as          | we increase | the       |
| synthesized        |     | by MimicGen1 |         | across    | 24 atomic      |     | tasks2 |            |              |                   |              |       |             |             |           |
...
dataset.
2Weexcludethekitchennavigationtask,asMimicGenisnotcurrentlyable relatively low cost. We observe several other notable findings
togeneratemobilemanipulationtrajectories.Weleavethistofuturework. intheresults.Someskillsaresignificantlyeasiertolearn(e.g.,
...
| challenging | (e.g., | pick | and place). |     | We hypothesize |     | a number |     |                   |     |      |       |     |
| ----------- | ------ | ---- | ----------- | --- | -------------- | --- | -------- | --- | ----------------- | --- | ---- | ----- | --- |
...
One example is the pick and place tasks involving dozens of PreSoakPan 0% 4.0%
|     |     |     |     |     |     |     |     |     | PrepareCoffee |     | 0%  | 0%  |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | ------------- | --- | --- | --- | --- |
...
forfiverepresentativecompositetasks.Wecomparelearningthesetasksfrom
| instances | of doors | and | is thus | significantly |     | easier | to learn. |     |     |     |     |     |     |
| --------- | -------- | --- | ------- | ------------- | --- | ------ | --------- | --- | --- | --- | --- | --- | --- |
...
| levels of | dexterity, | such | as insertion, |     | are challenging |     | to learn. |     |     |     |     |     |     |
| --------- | ---------- | ---- | ------------- | --- | --------------- | --- | --------- | --- | --- | --- | --- | --- | --- |
butstillstrugglestolearnrobustbehaviors.
| B. Imitation | Learning |             | for Composite |         | Tasks     |          |              |     |         |                |               |           |           |
| ------------ | -------- | ----------- | ------------- | ------- | --------- | -------- | ------------ | --- | ------- | -------------- | ------------- | --------- | --------- |
| Next         | we study | learning    |               | on our  | composite |          | tasks. These |     |         |                |               |           |           |
| tasks are    | more     | challenging |               | as they | require   | multiple | skills,      |     |         |                |               |           |           |
|              |          |             |               |         |           |          |              |     | cabinet | (either on the | right or left | side) and | place the |
...
| MicrowaveThawing: |     |     |     | This | task belongs |     | to the “de- |     |     |     |     |     |     |
| ----------------- | --- | --- | --- | ---- | ------------ | --- | ----------- | --- | --- | --- | --- | --- | --- |
• and difficulty effectively transitioning to the next stage of
frosting food” activity. The robot must place a frozen the task. However, we generally observe that the fine-tuned
| food | item | from | the counter |     | inside | the microwave | and |        |         |                       |      |             |         |
| ---- | ---- | ---- | ----------- | --- | ------ | ------------- | --- | ------ | ------- | --------------------- | ---- | ----------- | ------- |
|      |      |      |             |     |        |               |     | models | perform | better qualitatively, | with | more robust | picking |
turn on the microwave; and placing strategies in particular. We attribute this to the
RestockPantry:
• This task belongs to the “restocking large pretraining dataset of atomic behaviors. Our benchmark
...
| ----------- | --------- | --------- | ---- | ----------- | ------ | -------- | ----------- | ------------- | ----- | ------------ | --- | --------------- | --- | ------- | ----------- |
|             |           |           |      |             |        |          |             | Fig. 10: Real | Robot | Evaluations. |     | In a real-world |     | kitchen | domain with |
pickandplaceanobjectfromthecountertothesink.
...
| real-world | kitchen | environment |     | with | a Franka | Emika | Panda |           |          |          |     |               |     |         |           |
| ---------- | ------- | ----------- | --- | ---- | -------- | ----- | ----- | --------- | -------- | -------- | --- | ------------- | --- | ------- | --------- |
|            |         |             |     |      |          |       |       | ronments. | RoboCasa | features |     | 120 realistic |     | scenes, | dozens of |
robot running on the DROID hardware infrastructure [20]. appliances, 2,500+ high-quality 3D objects spanning 150+
| While both | the | real | world | and simulated |     | Franka | robot are |             |     |         |        |       |       |            |         |
| ---------- | --- | ---- | ----- | ------------- | --- | ------ | --------- | ----------- | --- | ------- | ------ | ----- | ----- | ---------- | ------- |
|            |     |      |       |               |     |        |           | categories, | 100 | diverse | tasks, | and a | large | multi-task | dataset |
...
| real robot | does | not. | In addition, | our | robot | controller | runs | at          |          |      |               |     |         |     |          |
| ---------- | ---- | ---- | ------------ | --- | ----- | ---------- | ---- | ----------- | -------- | ---- | ------------- | --- | ------- | --- | -------- |
|            |      |      |              |     |       |            |      | environment | textures | from | text-to-image |     | models, |     | and LLMs |
20Hzfrequencywhiletherealrobotcontrollerrunsat15Hz. to generate kitchen activities and corresponding tasks. In our
| In addition | to  | controller | differences, |     | there | are differences |     | in           |     |      |      |               |     |           |         |
| ----------- | --- | ---------- | ------------ | --- | ----- | --------------- | --- | ------------ | --- | ---- | ---- | ------------- | --- | --------- | ------- |
|             |     |            |              |     |       |                 |     | experiments, | we  | show | that | synthetically |     | generated | data in |
...
| cabinet. | These | tasks resemble |     | single-stage | tasks | in  | RoboCasa. |             |     |         |        |                   |     |     |           |
| -------- | ----- | -------------- | --- | ------------ | ----- | --- | --------- | ----------- | --- | ------- | ------ | ----------------- | --- | --- | --------- |
|          |       |                |     |              |       |     |           | and improve | the | quality | of our | machine-generated |     |     | datasets. |
...
|             |     |             |     |               |     |       |              | still required | human | guidance |     | to write | the | implementations |     |
| ----------- | --- | ----------- | --- | ------------- | --- | ----- | ------------ | -------------- | ----- | -------- | --- | -------- | --- | --------------- | --- |
| • Real+Sim: |     | co-training |     | on real-world |     | demos | for the tar- |                |       |          |     |          |     |                 |     |
...
manipulationbehaviorsbutdoesnotencapsulatehighlydexter-
| real-world | demonstrations). |     |     | On seen | objects, | we  | see that co- |     |     |     |     |     |     |     |     |
| ---------- | ---------------- | --- | --- | ------- | -------- | --- | ------------ | --- | --- | --- | --- | --- | --- | --- | --- |
...
|            |       |     |           |      |        |                |     | robot datasets. | We  | envision | a   | future | in which | these | diverse |
| ---------- | ----- | --- | --------- | ---- | ------ | -------------- | --- | --------------- | --- | -------- | --- | ------ | -------- | ----- | ------- |
| simulation | data. | We  | attribute | this | to the | rich diversity | and |                 |     |          |     |        |          |       |         |
...
ACKNOWLEDGMENTS domaindatasets.InRobotics:ScienceandSystems(RSS),
2022.
...
(N00014-22-1-2204).
arXiv
|     |     |     |     |     |     |     | reinforcement |                   | learning |     | on real-robot |     | hardware. |     |
| --- | --- | --- | --- | --- | --- | --- | ------------- | ----------------- | -------- | --- | ------------- | --- | --------- | --- |
...
Boosting generalization of robotic skills with cross- interactive 3d environment for visual ai. arXiv preprint

arXiv:1712.05474, 2017. Nasiriany, Chen Wang, Rohun Kulkarni, Li Fei-Fei,
...
[33] Ajay Mandlekar, Danfei Xu, Josiah Wong, Soroush [47] KevinZakka,YuvalTassa,andMuJoCoMenagerieCon-

tributors. MuJoCo Menagerie: A collection of high-
...
|                       |     | VII. | SIMULATOR |       |               |        |           | Skills      | (3):      | Pick_up(dairy), |       |          | Place(counter), |      |     |
| --------------------- | --- | ---- | --------- | ----- | ------------- | ------ | --------- | ----------- | --------- | --------------- | ----- | -------- | --------------- | ---- | --- |
|                       |     |      |           |       |               |        |           | Push(dairy, |           | blender)        |       |          |                 |      |     |
| We benchmark          |     | the  | speed     | of    | our simulator |        | on the    |             |           |                 |       |          |                 |      |     |
|                       |     |      |           |       |               |        |           | Reasoning:  | Preparing |                 | dairy | products |                 | near | a   |
| PickPlaceCounterToCab |     |      |           | task, | running       | for 10 | episodes, |             |           |                 |       |          |                 |      |     |
with each episode spawned in a random scene. We use native blender is common when making mixtures for
baking.
| MuJoCo | rendering | on  | an NVIDIA | RTX | A5000 | GPU | which |     |     |     |     |     |     |     |     |
| ------ | --------- | --- | --------- | --- | ----- | --- | ----- | --- | --- | --- | --- | --- | --- | --- | --- |
addsoverheadtothesimulationspeed.Thesimulationphysics
|         |            |        |              |      |          |      |       | Improper   | use of    | skills: |     |         |     |     |     |
| ------- | ---------- | ------ | ------------ | ---- | -------- | ---- | ----- | ---------- | --------- | ------- | --- | ------- | --- | --- | --- |
| runs on | CPUs       | and we | specifically | used | an AMD   | EPYC | 7543  |            |           |         |     |         |     |     |     |
|         |            |        |              |      |          |      |       | Task: Wine | Selection |         | for | Cooking |     |     |     |
| 32-Core | Processor. | The    | average      | time | to reset | the  | scene | is         |           |         |     |         |     |     |     |
9.50 seconds and the average speed of stepping through the Goal: Retrieve a bottle of wine from the
|     |     |     |     |     |     |     |     | cabinet | for | use in | a recipe |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | ------- | --- | ------ | -------- | --- | --- | --- | --- |
simulator(callingenv.step)is25.2fps.Withoutrendering,
theaverageresettimeis9.46secondsandthesimulatorspeed Objects: drink (wine)
| 31.9        |          |            |         |               |       |        |           | Fixtures:      | cabinet |                 | Skills | (5): |     |     |     |
| ----------- | -------- | ---------- | ------- | ------------- | ----- | ------ | --------- | -------------- | ------- | --------------- | ------ | ---- | --- | --- | --- |
| is          | fps. For | reference, |         | each timestep |       | in our | simulator |                |         |                 |        |      |     |     |     |
|             |          |            |         |               |       |        |           | Open(cabinet), |         | Pick_up(drink), |        |      |     |     |     |
| corresponds | to       | 0.04       | seconds | in the        | world | or 25  | fps. Our  |                |         |                 |        |      |     |     |     |
observed simulation speed with the rendering of 25.2 fps Place(counter), Close(cabinet),
Press(button_on_coffee_machine)(simulating
almostexactlymatchesthisspeed,meaningoursimulatorruns
| roughly | at real-time | speed. |     |     |     |     |     | uncorking) |      |     |              |     |      |           |     |
| ------- | ------------ | ------ | --- | --- | --- | --- | --- | ---------- | ---- | --- | ------------ | --- | ---- | --------- | --- |
|         |              |        |     |     |     |     |     | Reasoning: | Wine | is  | occasionally |     | used | in baking |     |
VIII. TASKSANDDATASETS recipes and needs to be opened and ready to
| A. Atomic | Tasks |        |       |              |       |              |     | use. |     |     |     |     |     |     |     |
| --------- | ----- | ------ | ----- | ------------ | ----- | ------------ | --- | ---- | --- | --- | --- | --- | --- | --- | --- |
...
|             |         |     |          |          |     |            |         | Goal: Gather |     | all utensils |     | needed |     | for baking |     |
| ----------- | ------- | --- | -------- | -------- | --- | ---------- | ------- | ------------ | --- | ------------ | --- | ------ | --- | ---------- | --- |
| (5) Turning | levers, | (6) | Pressing | buttons, | (7) | Insertion, | and (8) |              |     |              |     |        |     |            |     |
Navigation. We outline details for all tasks in Figure 11. Each (spoons, ladle) and place them on the
countertop.
| task can      | come | in the       | form | of multiple | task      | variants. | These     |          |          |     |     |     |     |     |     |
| ------------- | ---- | ------------ | ---- | ----------- | --------- | --------- | --------- | -------- | -------- | --- | --- | --- | --- | --- | --- |
|               |      |              |      |             |           |           |           | Objects: | utensils |     |     |     |     |     |     |
| task variants | can  | disambiguate |      | the         | task goal | with      | language. |          |          |     |     |     |     |     |     |
For pick-and-place tasks, there is a task variant for each Fixtures: drawer, counter
|                 |     |       |             |     |              |     |         | Skills | (4): | Open(drawer), |     | Pick_up(utensils), |     |     |     |
| --------------- | --- | ----- | ----------- | --- | ------------ | --- | ------- | ------ | ---- | ------------- | --- | ------------------ | --- | --- | --- |
| object category |     | being | manipulated | to  | disambiguate |     | objects | in     |      |               |     |                    |     |     |     |
clutter.Forturningonandoffthestove,thereisataskvariant Place(counter), Close(drawer)
|          |        |       |        |       |         |              |     | Reasoning: | Assembling |          | the | correct |       | utensils | is  |
| -------- | ------ | ----- | ------ | ----- | ------- | ------------ | --- | ---------- | ---------- | -------- | --- | ------- | ----- | -------- | --- |
| for each | burner | being | turned | on or | off, to | disambiguate | the |            |            |          |     |         |       |          |     |
|          |        |       |        |       |         |              |     | essential  | before     | starting |     | to      | bake. |          |     |
relevantburner.Fornavigation,thereisataskvariantforeach
...
| ------------ | --- | ----- | --- | --- | --- | --- | --- | ----------------- | ------ | ----------------- | ---- | --- | --------- | --------- | ------ |
| B. Composite |     | Tasks |     |     |     |     |     |                   |        |                   |      |     |           |           |        |
|              |     |       |     |     |     |     |     | machine-generated |        | datasets          | over | 25  | tasks.    | We render | images |
...
|          |        |           |           |     |              |     |           | to use the | light-weight |     | MuJoCo | renderer | to  | render images | for |
| -------- | ------ | --------- | --------- | --- | ------------ | --- | --------- | ---------- | ------------ | --- | ------ | -------- | --- | ------------- | --- |
| obtain a | set of | candidate | responses |     | and manually |     | select 20 |            |              |     |        |          |     |               |     |
...
Fixtures: counter, blender encodedobservationsarepassedtoa6-layerTransformerwith

∼ 20M trainable parameters. We train the model for 500k
...
observation history may be critical for our tasks.
...
stove knob.
TurnOffStove Turn off a specified stove burner by twisting the respective
|     | twisting knobs | stove knob. |     |     |     |     |     |     |     |
| --- | -------------- | ----------- | --- | --- | --- | --- | --- | --- | --- |
...
| ------------- | -------------- | -------- | ----------- | --- | --- | --- | --- | --- | --- |
CoffeePressButton Pressthebuttononthecoffeemachinetopourcoffeeintothe
pressing buttons
mug.
...
CoffeeServeMug Remove the mug from the coffee machine mug holder and
insertion
...
BowlAndCup
|     | Clearing the | table the cup | inside the | bowl and | move the | stacked items to the |
| --- | ------------ | ------------- | ---------- | -------- | -------- | -------------------- |
counter.
PrepForSanitizing
|     | Sanitizing | Organize | cleaning | supplies on | the counter | for easy access. |
| --- | ---------- | -------- | -------- | ----------- | ----------- | ---------------- |
...
| --- | ------- | ------- | -------------- | ----------- | -------- | --- |
DrainVeggies Washingfruitsandveg- Dump the veggies in the pot into the sink to drain. Turn off
...
there.
Fig.12:RepresentativeCompositeTasksAcross20KitchenActivites.
